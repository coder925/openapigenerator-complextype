...
export class PersonApiModule {
    public static forRoot(configurationFactory: () => Configuration): ModuleWithProviders<PersonApiModule> {
        return {
    ...
    constructor( @Optional() @SkipSelf() parentModule: PersonApiModule,
